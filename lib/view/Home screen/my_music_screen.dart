      ...
      itemBuilder: ((context, index) {
        return ListTile(
          ...
          trailing: myMusicOptionFunction(
              ...
              musicName: allAudioListFromDB[index].musicName.toString(),
              artistName: allAudioListFromDB[index].musicArtist.toString()),
          onTap: () async {
            await createAudiosFileList(allAudioListFromDB);
            await audioPlayer.playlistPlayAtIndex(index);

            await Navigator.of(context).push(MaterialPageRoute(builder: (ctx1) {
